...
from videoCapture.websocket import broadcast_custom_message, start_server
...
async def main():
    ...
    while True:
        ...
        try:
            ...
            cut += 1
            ret, frame = video_captures[cut%cameraNum].read()
            if not ret:
                print("第",cut%cameraNum,"摄像头失效")
                continue
            t=Task(frame,cut,"111")
            Queue.enqueue(t)
