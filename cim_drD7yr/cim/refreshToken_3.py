...
authCode = "06erT3OqMd14yJ78o86W2sVn"  # 需要更新
refreshToken = "g6DfRSFHqu8wLvDRtSxfSTOCeb0rJ5Em"
apiVersion = "2.0"
...
def main():
    ...
    # reqParam = "grantType=%s&authCode=%s&refreshToken=%s" % (grantType, authCode, refreshToken)
    reqParam = "grantType=%s&refreshToken=%s" % (grantType, refreshToken)
